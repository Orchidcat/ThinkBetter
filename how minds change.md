...
这种警惕的依赖导致了第二个困境。有时它会产生**假阴性**。一些完全准确和非常有用的新想法、发现和创新似乎好得令人难以置信，或者有时太具有挑战性或社会成本太高。看起来有毒但实际上没有的浆果可能会被忽视。一种禁忌的新生火方法可能仍然是一个人的创新。如果对信念、行为或态度的有希望的改变过于异常，认知警惕性可能会错误地将其标记为可疑。