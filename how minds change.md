...
对大脑来说，起初一切都是噪音。然后大脑会注意到静态的模式，然后他们会上升一个层次，注意到这些模式如何相互作用的模式。然后他们上升到另一个层次，注意到交互模式集如何与其他模式集交互的模式，以此类推；模式识别层建立在更简单的层之上，成为对我们周围世界的期望的粗略理解，它们的相互作用成为我们的因果感。圆球、桌子坚硬的边缘、毛绒玩具柔软的肘部，每一个物体都会刺激特定的神经通路，而不是其他的，每次接触都会加强它们之间的联系，直到大脑开始期待世界上的这些元素，并在语境中更好地理解它们。
