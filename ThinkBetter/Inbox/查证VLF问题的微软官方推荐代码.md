...
参考[tigertoolbox/Fixing-VLFs/Fix\_VLFs.sql at master · microsoft/tigertoolbox · GitHub](https://github.com/microsoft/tigertoolbox/blob/master/Fixing-VLFs/Fix_VLFs.sql)